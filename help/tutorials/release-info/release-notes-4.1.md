...
# Adobe Experience Managerガイドの最新リリース

## 最新リリースへのアップグレード

現在のバージョンのAdobe Experience Managerガイド ( 後で *AEMガイド*) をバージョン 4.1 にアップグレードします。AEMガイドのバージョン 4.1 へのアップグレードを進める前に、次の点を考慮する必要があります。

* バージョン 4.0.x を使用している場合は、直接バージョン 4.1 にアップグレードできます。4.1 にアップグレードする前に、バージョン 4.0.x にアップグレードする必要があります。
...
AEMガイドは、最新リリースの様々な機能強化と新機能を提供します。
