...
最も一般的なスタイルの使用方法について詳しくは、 [共通のコンテンツスタイルの使用](stylesheet.md)
...
**異なるセクションのページレイアウト**:次のセクションのレイアウト出力を使用して、ページレイアウトをマッピングするPDFを選択できます。
* 目次
* 図の一覧
* テーブルのリスト
* 章およびトピック
...
また、PDFで生成されるこれらの異なるセクションの順序を定義することもできます。 これらのページのデフォルトの順序を変更する場合は、ページレイアウトの左側にマウスポインターを置き、点線のバーアイコンをクリックして、ページレイアウトを目的の場所にドラッグ&amp;ドロップします。
