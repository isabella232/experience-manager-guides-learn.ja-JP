...
1. 次をクリック： [!UICONTROL **タグ表示を切り替え**] アイコンを再度クリックすると、タグが非表示になります。
...
1. [ 特殊文字を挿入 ] ダイアログボックスで、検索バーに文字の名前を入力します。
...
1. ユーザーの環境設定ダイアログで、 [!UICONTROL **テーマ**] ドロップダウン。
...
1. ユーザーの環境設定ダイアログで、 [!UICONTROL **フォルダー**] アイコンをクリックします。
...
1. ユーザーの環境設定ダイアログで、 [!UICONTROL **フォルダープロファイル**] ドロップダウン。
...
1. [ エディタ設定 ] ダイアログで、 [!UICONTROL **一般**] タブをクリックします。
...
1. [ エディタ設定 ] ダイアログで、 [!UICONTROL **パネル**] タブをクリックします。

1. 必要に応じて、使用可能なパネルを表示/非表示に切り替えます。
...
1. [ エディタ設定 ] ダイアログで、 [!UICONTROL **要素リスト**] タブをクリックします。

1. を入力します。 **要素名** および **ラベル** 各フィールド内の

1. 次をクリック： [!UICONTROL **プラス**] アイコンをクリックして、リストに要素を追加します。
...
1. [ エディタ設定 ] ダイアログで、 [!UICONTROL **属性リスト**] タブをクリックします。

1. を入力します。 **属性名** および **ラベル** 各フィールド内の

1. 次をクリック： [!UICONTROL **プラス**] アイコンをクリックして、リストに属性を追加します。
...
1. [ エディタ設定 ] ダイアログで、 [!UICONTROL **条件**] タブをクリックします。

1. 適用する条件のチェックボックスをオンにします。
...
1. [ エディタ設定 ] ダイアログで、 [!UICONTROL **プロファイル**] タブをクリックします。

1. 次をクリック： [!UICONTROL **プラス**] プロファイルの横のアイコン
