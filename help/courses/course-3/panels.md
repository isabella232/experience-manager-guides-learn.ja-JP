...
2. 二重矢印が表示されたら、必要に応じて内側または外側にドラッグします。
...
2. 次をクリック： [!UICONTROL **サイドバー**] アイコンを再度クリックして、パネルを折りたたみます。
...
2. 次をクリック： [!UICONTROL **プラス**] アイコン

   ![お気に入りプラス](images/lesson-5/favorites-plus.png)

3. 新しいコレクションダイアログで、 **タイトル** および **説明**.
...
2. 次をクリック： [!UICONTROL **省略記号**] トピックの横にある「 」をクリックして、コンテキストオプションにアクセスします。

3. 選択 **追加先** > **お気に入り**.

4. お気に入りに追加ダイアログで、 **新しいコレクション** または **既存のコレクション**.

   ここでは、既存のコレクションに追加することを選択します。

   ![お気に入りダイアログ](images/lesson-5/add-to-favorites-dialog.png)

5. 必要に応じて、ドロップダウンからコレクションを選択します。

6. 「[!UICONTROL **追加**]」をクリックします。
...
2. トピックをダブルクリックして開きます。

3. ファイルの **「タイトル」タブ** をクリックして、コンテキストオプションにアクセスします。

4. 選択 **追加先** > **お気に入り**.

   ![お気に入りに追加](images/lesson-5/addto-favorites.png)

5. お気に入りに追加ダイアログで、 **新しいコレクション** または **既存のコレクション**.

   ここでは、新しいコレクションに追加を選択します。

6. 新しいコレクションダイアログで、 **タイトル** および **説明**.

   なお、「 **公開** は、他のユーザーがこのお気に入りを表示できることを意味します。

7. 「[!UICONTROL **作成**]」をクリックします。
...
2. [ お気に入り ] で、 [!UICONTROL **矢印**] コレクションの横にあるアイコンで、そのコンテンツを表示します。

   ![お気に入りの表示](images/lesson-5/view-favorites.png)

3. 次をクリック： [!UICONTROL **省略記号**] トピックの横に、お気に入りリストから削除するオプションなど、コンテキストオプションが表示されます。
...
2. 次をクリック： [!UICONTROL **検索をフィルター**] アイコン

   ![リポジトリフィルターアイコン](images/lesson-5/repository-filter-icon.png)

3. 選択したパスにテキストを入力するか、必要に応じて新しいパスを選択します。

   フィルタにテキストを入力すると、ファイルのリストが更新されます。

4. 必要に応じて、検索カテゴリの横にある矢印アイコンをクリックして、検索をさらに絞り込みます。
...
3. 要素内の 2 番目のマウスボタンをクリックします。

4. 表示されたメニューで、「作成」を選択します。 [!UICONTROL **スニペット**].

   ![スニペットを作成](images/lesson-5/create-snippet.png)

5. 新しいスニペットダイアログで、 **タイトル** および **説明**.
...
2. 次をクリック： [!UICONTROL  **ファイルのプロパティ**] アイコンをクリックします。

   ![ファイルプロパティアイコン](images/lesson-5/file-properties-icon.png)

3. を **ドキュメントの状態** から **編集**. 現在、「参照」リストは空白です。

   ![参照なし](images/lesson-5/no-references.png)

4. トピックを閉じます。

5. 選択 [!UICONTROL **リポジトリ表示**] をクリックします。

6. マップを開きます。

   ビューが [ マップビュー ] に変わります。

7. [!UICONTROL **編集**]&#x200B;アイコンをクリックします。

   ![マップを編集アイコン](images/lesson-5/edit-map-icon.png)

8. マップを開いて編集したら、次に切り替えます。 **リポジトリ表示**.

9. 使用するトピックをマップにドラッグ&amp;ドロップします。

10. 次をクリック： [!UICONTROL **保存**] アイコンをクリックします。
...
2. クリック [!UICONTROL **レビューを作成**].

   ![レビューを作成](images/lesson-5/create-review.png)

3. レビュータスクを作成ダイアログで、必要に応じてフィールドに値を入力します。

4. 「[!UICONTROL **次へ**]」をクリックします。
